...
module.exports = class Server {
	 ...
	 * @param {Number} [obj.captureGroup] Regex capturegroup that contains the relevant data
	 * @param {Boolean} [obj.trimQuotes] Should " be trimmed?
	...
	findLink(html) {
		...
		if (result) {
			...
			// TODO remove feature in next major plugin version
			if (this.trimQuotes) {
				link = link.split('"')[1];
			}
			return link;
