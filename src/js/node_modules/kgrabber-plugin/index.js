...
const Plugin = require("./Plugin"),
	$ = unsafeWindow.$, // use the jquery instance of the page, not the script
	version = require("./version");

const applicationName = "KGrabberPlugin",
...
function init(callback) {
	...
	$(document).on(`${applicationName}/DiscoverRequest`, () => {
		$(document).trigger(`${applicationName}/DiscoverResponse`, { pluginID, version });
	});
...
module.exports = new Plugin(init);
